...
![The approved slide gives the soup-can series most of the screen so repetition and label differences are visible.](lesson1-repetition.png)
...
![The name MAYA appears in three flat contrasting color combinations, each with a nearby label.](lesson1-flat-color.png)
...
![The approved Pop Art work slide combines Make, Ready to turn in, Turn it in, a reflection stem, name-tag exemplars, and the actual Canvas assignment banner.](lesson1-protected-work-slide.png)
...
![Two side-by-side line compositions ask which feels relaxed and which feels intense or urgent. No answer labels are visible.](lesson2-lines-question.png)

### Reveal, then explain the cues — slide 6 after one click

![The same compositions remain visible with Relaxed and Intense/movement labels and an explanation of open space, gentle curves, tight clusters, and changing lengths.](lesson2-lines-reveal.png)
...
![The Canva demo slide shows a real editor screenshot alongside Lines, Shapes, Borders, Size and spacing, and Layers.](lesson2-live-demo.png)
