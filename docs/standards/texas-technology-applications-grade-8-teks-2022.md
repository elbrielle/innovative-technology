# Texas Technology Applications, Grade 8 TEKS

## Canonical source record

| Field | Value |
| --- | --- |
| State rule | 19 Texas Administrative Code (TAC), §126.19 |
| Official title | Technology Applications, Grade 8, Adopted 2022 |
| Source document | [TEA: Chapter 126, Subchapter B (Middle School)](https://tea.texas.gov/laws-and-rules/sboe-rules-tac/sboe-tac-currently-effect/ch126b.pdf) |
| Source document label | August 2024 Update |
| Source SHA-256 | `d6713edd160a40d22bd65b4326d2dc5286935719ea329f9da78e7a45202b04da` |
| Rule source note | §126.19 was adopted effective August 7, 2022, 47 TexReg 4518. |
| Implementation | 2024-2025 school year and subsequent school years |
| Retrieved and transcribed | 2026-08-19 |

This file is the VILS canonical, verbatim transcription of **§126.19(c), Knowledge and skills**. Preserve the code and wording exactly when it is cited in Canvas facilitator guides, the public facilitator-guide site, or any TEKS-alignment record. Do not silently modernize punctuation, spelling, or wording. If the state changes this rule, create a new dated source record; do not overwrite this one.

The state’s guidance in §126.19(b)(4) applies: statements containing **including** reference content that must be mastered; statements containing **such as** are illustrative examples.
...
- **§126.19(c)(1)(D):** design a plan collaboratively using pseudocode to document a problem, possible solutions, and an expected timeline for the development of a coded solution;
...
- **§126.19(c)(3)(A):** demonstrate innovation in a design process using goal setting and personal character traits, including demonstrating calculated risk-taking and tolerance;
...
- **§126.19(c)(4)(A):** evaluate how changes in technology throughout history have impacted various areas of study;
...
- **§126.19(c)(8)(A):** analyze the importance of managing a digital footprint and how a digital footprint can affect the future;
...
- **§126.19(c)(9)(A):** adhere to local acceptable use policy (AUP) and practice and advocate for safe, ethical, and positive online behaviors;
- **§126.19(c)(9)(B):** adhere to appropriate intellectual property law when creating digital products;
...
- **§126.19(c)(12)(A):** integrate use of appropriate technology terminology in scholarly inquiry and dialogue such as classroom discussion and written samples;
- **§126.19(c)(12)(B):** implement effective file management strategies independently, including file naming conventions, local and remote locations, backup, hierarchy, folder structure, file conversion, tags, and emerging digital organizational strategies;
- **§126.19(c)(12)(C):** select and use appropriate platform and tools, including selecting and using software or hardware to transfer data;
- **§126.19(c)(12)(D):** demonstrate improvement in speed and accuracy as measured by words per minute when applying correct keyboarding techniques;
- **§126.19(c)(12)(E):** select and use appropriate shortcuts within applications;
- **§126.19(c)(12)(F):** apply appropriate troubleshooting techniques and seek technical assistance as needed;
- **§126.19(c)(12)(G):** compare types of local and remote data storage such as cloud architecture or local server and select the appropriate type of storage to store and share data; and
...
## Alignment use policy

For every future VILS module alignment, record these fields together:

1. **Essential standard(s):** one or more relevant strand-level headings or full student-expectation statements above.
2. **Aligned sub-TEKS:** only the precise §126.19(c)(...) code(s) the module actually teaches and elicits evidence for.
3. **Student evidence:** the particular product, response, revision, or demonstration that supports the alignment.
4. **Scope status:** `introduced`, `practiced`, or `demonstrated`—not a compliance claim based only on topical mention.

This structure allows the same alignment record to drive the Canvas facilitator guide and the generated public facilitator-guide site without maintaining two different lists.
